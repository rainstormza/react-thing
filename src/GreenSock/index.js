      ...
      <div className="container">
        <div className="row">
          <div className="col-12 mt-3">
            ...
            <p>
              Animates the GSAP logo to the right of it's original position and finally does a 360
              degrees rotation. You can use the buttons to control the animation.
            </p>
            <p>
              Uses the <strong>ref</strong> inline callback to create a reference to the DOM
              element, which is then used in the <strong>componentDidMount</strong> event to create
              the GSAP instance.
            </p>
            <hr />
          </div>
